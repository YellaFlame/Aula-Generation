...
public class ContatoControllerTest {
	...
	public void deveRealizarPostContatos() {
		...
		ResponseEntity<Contato> resposta = testRestTemplate.exchange("/contatos/inserir", HttpMethod.POST, request,
				Contato.class);
	...
	public void deveRealizarPutContatos() {
		...
		ResponseEntity<Contato> resposta = testRestTemplate.exchange("/contatos/alterar", HttpMethod.PUT, request,
				Contato.class);
		Assertions.assertEquals(HttpStatus.OK, resposta.getStatusCode());
	}
	...
	public void deveRealizarDeleteContatos() {
		ResponseEntity<String> resposta = testRestTemplate.exchange("/contatos/3", HttpMethod.DELETE, null,
				String.class);
		Assertions.assertEquals(HttpStatus.OK, resposta.getStatusCode());
	}
}
